...
//
    ...
    // załaduj sprite'y
    const SpriteConfigData horizontal_road_data(DL::Foreground, 1, 1, 0 * 32, 17 * 32, 32, 32, false);
    const SpriteConfigData vertical_road_data(DL::Foreground, 1, 1,  1 * 32, 17 * 32, 32, 32, false);
    const SpriteConfigData entry_enabled_data(DL::Foreground, 4, .1,  4 * 32, 17 * 32, 32, 32, true);
    const SpriteConfigData face_data(DL::Foreground, 4, .1,  0 * 32, 23 * 32, 32, 32, true);
